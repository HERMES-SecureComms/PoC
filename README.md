...
[아키텍처 문서](docs/ARCHITECTURE.md)에 설명되어 있다.
...
전에 [상세 배선 문서](docs/WIRING.md)를 확인한다.
...
상세 수동 검증 절차는 [TEST_PLAN.md](docs/TEST_PLAN.md)에 있다.
...
재사용 전에 [SECURITY.md](SECURITY.md)를 읽는다.
...
포함되지 않는다. 상세 내용은 [ROADMAP.md](docs/ROADMAP.md)에 있다.
